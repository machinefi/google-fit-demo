...
contract Sleepr is ERC1155, AccessControl, ERC1155Supply {
    ...
    function mintFromAllowance(uint256 id, bytes memory data) public {
        uint256 amount = allowance[id][msg.sender];
        require(amount > 0, "Insufficient allowance");
        allowance[id][msg.sender] -= amount;
